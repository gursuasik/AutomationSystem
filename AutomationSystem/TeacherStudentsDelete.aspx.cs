...
namespace AutomationSystem
{
    public partial class WebForm4 : System.Web.UI.Page
    {
        ...
        {
            DataProcess("DELETE * FROM Students WHERE ID =" + Convert.ToInt32(GridView1.DataKeys[e.RowIndex].Values[0].ToString()));
            DataSelect();
        }
        ...
        public void DataProcess(string cmdtext)
        {
            ...
            OleDbCommand Komut = new OleDbCommand(cmdtext, connection);
