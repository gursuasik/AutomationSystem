...
namespace AutomationSystem
{
    public partial class WebForm2 : System.Web.UI.Page
    {
        ...
        protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            {
                TextBox txtNewUserName = (TextBox)GridView1.FooterRow.FindControl("UserName");
                TextBox txtNewPass = (TextBox)GridView1.FooterRow.FindControl("Pass");

                DataProcess("INSERT INTO Users (Authority, UserName, Pass) VALUES ('1', '" + txtNewUserName.Text + "','" + txtNewPass.Text + "')");
                DataSelect();
            }
        }
        protected void GridView1_RowUpdating(object sender, GridViewUpdateEventArgs e)
        {
            ...
            DataProcess("UPDATE Personel SET Adi ='" + txtNewAdi + "', Soyadi ='" + txtNewVize + "' WHERE PersonelId=" + Convert.ToInt32(GridView1.DataKeys[e.RowIndex].Values[0].ToString()));
        ...
        private void DataSelect()
        {
            ...
            OleDbDataAdapter adapter = new OleDbDataAdapter("SELECT ID, UserName, Pass FROM Users", connection);
